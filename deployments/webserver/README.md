...
Module `sdkwork-canvas` · runtime code `canvas` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `canvas-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `canvas-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `canvas-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `canvas-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `canvas.sdkwork.com` | 443 ssl + 80 |
