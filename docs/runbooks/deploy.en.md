# Runbook — sdkwork-canvas deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-canvas-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-canvas/bundle`, loads the image, starts
