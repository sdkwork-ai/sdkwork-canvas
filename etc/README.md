# sdkwork-canvas Source Configuration
...
| `runtimeCode` | `canvas` |
| Config root | `/etc/sdkwork/canvas/` |
| Runtime TOML | `/etc/sdkwork/canvas/config.toml` |
| Secrets | `/etc/sdkwork/canvas/secrets/` |
| Override | `SDKWORK_CANVAS_CONFIG_FILE` |
